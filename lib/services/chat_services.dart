...
class ChatService {
  ...
  List<Map<String, String>> _prepareMessages(List<Message> messages) {
    ...
    formattedMessages.add(
      {
        "role" : "system",
        "content" : "You are an assitant of an app named Fit Connect, to empower athletes with expert coaching and tailored nutrition support to reach their full potential. answer briefly"
      }
    );
